...
public:
    explicit XbeeController(pigeons_mission_viewer::controllers::CommunicationController* messageParser = nullptr, QObject* parent = nullptr);
...
private:
    ...
    libxbee::XBee* xbee;
    connectionCB* con;
    controllers::CommunicationController* messageParser;
};
