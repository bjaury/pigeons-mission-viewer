...
#include "serialport-settings-manager.h"
#include <QCoreApplication>

namespace pigeons_mission_viewer {
namespace serial{

SerialPortSettingsManager::SerialPortSettingsManager(QObject *parent) : QObject(parent) {
...
SerialPortSettingsManager::~SerialPortSettingsManager() {

}

void SerialPortSettingsManager::updateSettings(QString portName, QString baudRate, QString dataBits, qint32 parity, qint32 stopBits, qint32 flowControl) {
    qDebug() << "\n\t\tSettings Changed !\n";
...
SerialPortSettingsManager::SerialSettings SerialPortSettingsManager::currentSettings() const {
    return m_currentSettings;
}

QVariant SerialPortSettingsManager::availablePorts() {
...
QVariant SerialPortSettingsManager::availableBaudRates() {
